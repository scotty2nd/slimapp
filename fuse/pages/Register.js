...
function Register() {
	/*
		To Do:
		- Webview page nav animation glitsch
...
function ShowTermsPopup() {
	...
	include.popup.text.value = "<RegularText>Test123</RegularText><p>lorem ipsum fff Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>";						// Variable soll im nächsten Step via Fetch vom Server abgerufen werden
	include.ShowPopup("", "Nutzungsbestimmungen", "Close");		// Popup anzeigen
}

function ShowPrivacyPopup() {
	include.popup.text.value = "<BoldText>Test456</BoldText>";						// Variable soll im nächsten Step via Fetch vom Server abgerufen werden
